      ...
      <Head>
        <Tailwind>
          <Body className="bg-white my-12 mx-auto font-sans">
            <Container className="p-8 rounded-lg mx-auto shadow-lg text-center">
              <Img className="mx-auto w-24 rounded-full" src="https://sinisaandrijevic.com/assets/img/ogimage.jpg"></Img>
